...
//	protected double lastReward;
	 ...
	 */
	public CETrajectoryGenerator(StateGenerator gen, CEPolicy policy, RewardFunction reward) {
		_stateGen = gen.copy();
		_policy = policy.copy();
	 ...
	 */
	public CETrajectoryGenerator(CETrajectoryGenerator other) {
	 ...
	 */
	public abstract CETrajectoryGenerator copy();
	
	/**
	 * Returns a generated Trajectory
	 */
	public CETrajectory call() {
	 ...
	 */
	public CETrajectory get_trajectory() {
		initialize();
		generate_trajectory();
		return new CETrajectory(_trajectory);
	}
...
//		lastReward = 0;
		_trajectory = new CETrajectory();
		_trajectory.setParams(_policy.sampleParams());
	}
